...
{
	// To Do: -h -v help verbose
	
	// bug: args 5-9 get floating point exception which is weird because 
	// there's no floating point in this program.
	
	if ( argc <= 1 || atoi(argv[1]) <= 0 ) {
		printf("Example:\n");
		printf("filterPrime 1000\n");
		filterPrimeVerbose(1000,1);
		return -1;
	}
